 ...
 */
public class KechengdayiVO  implements Serializable {
	...
	public void setYiwenjieda(String yiwenjieda) {
		this.yiwenjieda = yiwenjieda;
	}
	
	/**
	 * 获取：疑问解答
	 */
	public String getYiwenjieda() {
		return yiwenjieda;
	}
