...
import adminexam from '@/views/modules/exampaperlist/exam'
    ...
    import kechengyiwen from '@/views/modules/kechengyiwen/list'
    ...
    import kechengdayi from '@/views/modules/kechengdayi/list'
    ...
    import kechengziliaoku from '@/views/modules/kechengziliaoku/list'
...
const routes = [{
	...
	path: '/examrecord',
      ...
      ,{
	path: '/kechengziliaoku',
        name: '课程资料库',
        component: kechengziliaoku
      }
    ]
  },
  {
