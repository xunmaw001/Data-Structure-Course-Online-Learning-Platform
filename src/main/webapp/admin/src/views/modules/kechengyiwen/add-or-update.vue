    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="疑问内容" prop="yiwenneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="疑问内容"
                  v-model="ruleForm.yiwenneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yiwenneirong" label="疑问内容" prop="yiwenneirong">
                    <span>{{ruleForm.yiwenneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kechengleixing = true;
          ...
          if(o=='yiwenneirong'){
            this.ruleForm.yiwenneirong = obj[o];
	    this.ro.yiwenneirong = true;
            continue;
          }
          if(o=='faburiqi'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `kechengyiwen/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kechengyiwenCrossAddOrUpdateFlag = false;
                  this.parent.search();
