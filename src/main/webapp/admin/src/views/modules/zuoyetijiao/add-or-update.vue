<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="提交文件" prop="tijiaowenjian">
          <file-upload
          tip="点击上传提交文件"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tijiaowenjian" label="提交文件" prop="tijiaowenjian">
            <el-button type="text" size="small" @click="download(ruleForm.tijiaowenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
