<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="批改文件" prop="pigaiwenjian">
          <file-upload
          tip="点击上传批改文件"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.pigaiwenjian?ruleForm.pigaiwenjian:''"
          @change="pigaiwenjianUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.pigaiwenjian" label="批改文件" prop="pigaiwenjian">
            <el-button type="text" size="small" @click="download(ruleForm.pigaiwenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zuoyemingcheng = true;
          ...
          if(o=='pigaiwenjian'){
            this.ruleForm.pigaiwenjian = obj[o];
	    this.ro.pigaiwenjian = true;
            continue;
          }
          if(o=='chengji'){
    ...
    pigaiwenjianUploadChange(fileUrls) {
	this.ruleForm.pigaiwenjian = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
