    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="疑问解答" prop="yiwenjieda">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="疑问解答"
                  v-model="ruleForm.yiwenjieda" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yiwenjieda" label="疑问解答" prop="yiwenjieda">
                    <span>{{ruleForm.yiwenjieda}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kechengleixing = true;
          ...
          if(o=='yiwenjieda'){
            this.ruleForm.yiwenjieda = obj[o];
	    this.ro.yiwenjieda = true;
            continue;
          }
          if(o=='fabushijian'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `kechengdayi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kechengdayiCrossAddOrUpdateFlag = false;
                  this.parent.search();
