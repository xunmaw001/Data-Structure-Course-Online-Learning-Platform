<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="作业内容" prop="zuoyeneirong">
          <file-upload
          tip="点击上传作业内容"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zuoyeneirong" label="作业内容" prop="zuoyeneirong">
            <el-button type="text" size="small" @click="download(ruleForm.zuoyeneirong)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="作业简述" prop="zuoyejianshu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="作业简述"
                  v-model="ruleForm.zuoyejianshu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zuoyejianshu" label="作业简述" prop="zuoyejianshu">
                    <span>{{ruleForm.zuoyejianshu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zuoyemingcheng = true;
          ...
          if(o=='zuoyejianshu'){
            this.ruleForm.zuoyejianshu = obj[o];
	    this.ro.zuoyejianshu = true;
            continue;
          }
          if(o=='zuoyeneirong'){
